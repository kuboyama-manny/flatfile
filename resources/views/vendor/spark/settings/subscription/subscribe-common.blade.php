                ...
                <tr v-for="plan in paidPlansForActiveInterval">
                    ...
                    <td>
                        <span class="table-plan-text">
                            <strong class="table-plan-price">@{{ (plan.interval == 'yearly' ? priceWithTax(plan) / 12 : priceWithTax(plan)) | currency }}</strong>
                            ...
                            / Month
                            <div v-if="plan.interval == 'yearly'"><small>(@{{priceWithTax(plan) | currency}} billed yearly)</small></div>
                        </span>
                    </td>
