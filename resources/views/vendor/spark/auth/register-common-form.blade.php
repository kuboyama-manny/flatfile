<form role="form">
    @if (Spark::usesTeams() && Spark::onlyTeamPlans())
        ...
        <div class="form-group row" v-if=" ! invitation">
            <label class="col-md-12 col-form-label">{{ __('teams.team_name') }}</label>
        ...
        @if (Spark::teamsIdentifiedByPath())
            ...
            <div class="form-group row" v-if=" ! invitation">
                <label class="col-md-12 col-form-label">{{ __('teams.team_slug') }}</label>
    ...
    <div class="form-group row">
        <label class="col-md-12 col-form-label">{{__('Name')}}</label>
    ...
    <!-- E-Mail Address -->
    <div class="form-group row">
        <label class="col-md-12 col-form-label">{{__('E-Mail Address')}}</label>
